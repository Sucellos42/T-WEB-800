...
let GoogleController = class GoogleController {
    ...
    async googleAuthRedirect(req, res) {
        const data = this.googleService.googleLogin(req);
        const token = encodeURIComponent(data.user.accessToken);
        const firstName = encodeURIComponent(data.user.firstName);
